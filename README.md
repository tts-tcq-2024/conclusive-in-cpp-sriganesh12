...
- Enter Reflections: Replace the spaces in the **Reflections** section below, within this file. This workflow fails till you replace it with your impressions.
...
**I will try to modularize the code into multiple function and try to reuse it whenever possible**
